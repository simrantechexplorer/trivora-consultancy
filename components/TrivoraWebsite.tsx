...
import { Mail, Phone, Linkedin, Drone, Users, MapPinned, GraduationCap } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 bg-black/40 backdrop-blur border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <Drone className="h-8 w-8 text-indigo-400" />
            <span className="text-xl font-bold tracking-wide">Trivora Consultancy</span>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-14 items-center">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">
            ...
            <span className="block text-indigo-400"><span className="block text-indigo-300 font-bold tracking-wide">Powered by Expertise</span></span>
          </h1>
          <p className="mt-6 text-slate-300 max-w-xl">
            Trivora Consultancy delivers advanced drone solutions, GIS intelligence, and
            HR-driven recruitment & training services tailored for modern industries.
          </p>
          <div className="mt-8 flex gap-4">
            <a href="#contact"><Button className="bg-indigo-600 hover:bg-indigo-700">Get in Touch</Button></a>
            <a href="#services">
  <Button
    variant="outline"
    className="border-indigo-500 text-indigo-300 hover:text-white hover:bg-indigo-600"
  >
    Explore Services
  </Button>
</a>
      ...
      <section id="services" className="bg-black/30 py-24">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-14">Our Services</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[{
              icon: <Drone className="h-10 w-10 text-indigo-400" />,
              title: "Drone Surveys",
              desc: "High-precision aerial surveys for mapping, inspection and analytics."
            }, {
              icon: <MapPinned className="h-10 w-10 text-indigo-400" />,
              ...
              <motion.div key={i} whileHover={{ y: -8 }}>
                <Card className="bg-slate-800/90 border-indigo-500/30 shadow-lg shadow-indigo-500/10 h-full">
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="mt-6 text-slate-300">
              ...
              intelligence. Our consultancy blends HR excellence with cutting-edge aerial
              and GIS technologies.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-6">
            {["Industry Expertise", "Certified Professionals", "Scalable Solutions", "Client-Centric Approach"].map((t, i) => (
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <p className="flex items-center gap-3"><Mail /> trivoraconsultancy@gmail.com</p>
              <p className="flex items-center gap-3"><Phone /> 7307111066</p>
              <a
